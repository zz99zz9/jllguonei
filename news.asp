...
<div class="part1">
<div class="container">
    <ul class="nav2"><a class="hand <%if cid=0 then%>on<%end if%>" href="news.asp">全部</a><a class=" hand <%if cid=11 then%>on<%end if%>" href="news.asp?cid=11">豪宅研究报告</a><a class="hand <%if cid=12 then%>on<%end if%>" href="news.asp?cid=12">最新活动</a><!--<a class="hand <%if cid=15 then%>on<%end if%>" href="2.asp?cid=15">生活品鉴</a>--></ul>
    <ul class="news">
     <%
