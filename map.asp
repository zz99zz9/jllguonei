...
<div class="col-md-4 input-group"><input  class="form-control" type="text" placeholder="翠湖天地"><span class="input-group-btn"><button class="btn" type="button" onclick="location.href='newhouse.asp'">搜索</button></span></div>
</div>
</div>
</div>
<!--广告部份-->
...
<div class="part7">
<a href="jllmap.asp"><img src="xgwl/img/temp/mapp3.gif" class="mapp"></a>
<iframe scrolling='no'
