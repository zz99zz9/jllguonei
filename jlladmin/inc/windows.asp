...
<input type="hidden" name="SmallClassId" class="form-control" id="SmallClassId"  >
 <input type="hidden" name="SAction" class="form-control" id="SAction" value="add">
    ...
    <div class="form-group">
    <label for="Szb" class="col-sm-3 control-label text-right">百度坐标</label>
    <div class="col-sm-8">
      <input type="text" name="Szb" value="" class="form-control" id="Szb" placeholder="" data-toggle="tooltip" title="请正确输入坐标信息">
    </div>
  </div>
    <div class="form-group">
