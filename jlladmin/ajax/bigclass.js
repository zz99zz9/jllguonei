...
$(".ssave").click(function(){
	...
	if ($("#SmallClassName").hasClass("no")||$("#SmallClassName").val()==""||$("#SOrderID").hasClass("no")||$("#SOrderID").val()==""){
		...
		$(this).attr("data-dismiss","modal");//隐藏弹窗
 XgSmallClass(BCName,BCID,SCName,SCID,SAction,SOID,Szb);//执行修改小类操作
	}
	}
})
/////////////////////////////////////
//         小类修改传值给JSON         //
/////////////////////////////////////
function XgSmallClass(BCName,BCID,SCName,SCID,SAction,SOID,Szb){
		//ajax操作数据库
