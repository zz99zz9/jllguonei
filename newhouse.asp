...
<% end if
 next %><br><%=rs("clbname")%><br></span>
    ...
    </div><div class="nphone"><span class="jiage">¥<%=rs("jgzj")%><b class="b1">万起</b><!--<b class="b2">(每平)</b>--></span><div class="c hidden-xs"></div><a href="housedetails.asp?id=<%=rs("articleid")%>" class="nbtn">查看更多</a></div></li>
<%
rs.movenext
i=i+1
loop
